...
class wpdb {
	...
	public function set_sql_mode( $modes = array() ) {
		 ...
		 */
		$incompatible_modes = array();//(array) apply_filters( 'incompatible_sql_modes', $this->incompatible_modes );
	...
	public function check_connection( $allow_bail = true ) {
		...
		for ( $tries = 1; $tries <= $this->reconnect_retries; $tries++ ) {
			...
			if ( $this->reconnect_retries === $tries &&  isset($GLOBALS['DEBUG']) && $GLOBALS['DEBUG']>=2  ) {
				error_reporting( $error_reporting );
			}
	...
	public function query( $query ) {
		 ...
		 * @param string $query Database query.
		 */
		//$query = array();//apply_filters( 'query', $query );
	...
	protected function get_table_charset( $table ) {
		 ...
		 */
		$charset = array();//apply_filters( 'pre_get_table_charset', null, $table );
		if ( null !== $charset ) {
			return $charset;
		}
	...
	public function get_col_charset( $table, $column ) {
		 ...
		 */
		$charset = array();//apply_filters( 'pre_get_col_charset', null, $table, $column );
		if ( null !== $charset ) {
			return $charset;
		}
