...
class DefaultPage extends PageBuilder{
    ...
    public static function Generate()
    {
        ...
        echo "<html lang='".DefaultPage::$Lang."'>".$newline;
        echo " <head>".$newline;
        echo "  <meta charset='".DefaultPage::$Encoding."'>".$newline;
        echo "  <title>".DefaultPage::$Title."</title>".$newline;
        echo DefaultPage::$Meta.$newline;
